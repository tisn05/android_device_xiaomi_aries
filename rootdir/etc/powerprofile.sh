...
case "$powermode" in
	...
	"1")
		...
		echo -e "900\n1000\n1100\n" > /sys/devices/system/cpu/cpu0/cpufreq/gpu_mv_table
		echo "192000 860000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "384000 880000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "486000 880000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "594000 880000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "702000 880000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "810000 900000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "918000 920000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1026000 940000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1134000 960000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1242000 980000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1350000 1000000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1458000 1020000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1566000 1040000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1674000 1060000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
		echo "1728000 1080000" > /sys/devices/system/cpu/cpufreq/vdd_table/vdd_levels
	;;
	"0")
...
# Balance:     CPU --> PVS-ME & GPU --> PowerSave
